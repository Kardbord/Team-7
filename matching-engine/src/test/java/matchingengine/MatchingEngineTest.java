...
public class MatchingEngineTest {
    ...
    public void handleOrderTest(){
        ...
        ForwardOrderMessage forwardOrderMessage = new ForwardOrderMessage((short)2,
...
//        (playerId, orderType, quantity, price, symbol)
        ...
        forwardOrderMessage = new ForwardOrderMessage((short)2,
        ...
        forwardOrderMessage = new ForwardOrderMessage((short)2, SubmitOrderMessage.OrderType.SELL,
    ...
    public void cancelOrderTest(){
        ...
        victim.orderHandler.handleOrder(forwardOrderMessage);
        assertEquals(1,victim.restingBook.sellers.size());
        ForwardCancelMessage cancelOrderMessage = new ForwardCancelMessage((short)2,(short)3,"GOOG");
        victim.cancelOrderTester(cancelOrderMessage);
        //Nothing should have changed as wrong ID was provided
        assertEquals(1,victim.restingBook.sellers.size());
        cancelOrderMessage = new ForwardCancelMessage((short)2,(short)1,"GOOG");
        victim.cancelOrderTester(cancelOrderMessage);
